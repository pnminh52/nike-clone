...
>
  ...
  className={`block h-15.5 rounded-lg p-3.5 text-lg inter w-full text-gray-900 bg-transparent border appearance-none focus:outline-none focus:ring-0 peer 
    ${touched && error ? "border-[#D30005] border" : "border-black"}`
  }
  placeholder=" "
  value={email}
...
/>
 ...
 <label
  ...
  className={`absolute text-lg inter rounded-lg duration-300 transform -translate-y-4 scale-75 top-1.5 bg-white px-1 z-10 origin-[0] left-3
    ...
    ${error ? '!text-[#D30005]' : 'text-gray-500'}`}
>
  Email*
</label>
...
{error && <p className="text-[#D30005] text-sm inter ml-4 mt-1.5">{error}</p>}
  ...
  <input
    ...
    id="password"
    className={`block h-15.5 rounded-lg p-3.5 text-lg inter w-full text-gray-900 bg-transparent border appearance-none focus:outline-none focus:ring-0 peer 
      ${touched && !password ? "border-[#D30005] border" : "border-black"}`
    }    placeholder=" "
    value={password}
  ...
  className={`absolute text-lg inter rounded-lg duration-300 transform -translate-y-4 scale-75 top-1.5 bg-white px-1 z-10 origin-[0] left-3
    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-3 peer-focus:scale-75 peer-focus:-translate-y-4
    ${!password ? '!text-[#D30005]' : 'text-gray-500'}`}
>
  Password*
</label>
  <div
     ...
     {step===1?(
       <p className="mt-2 text-lg text-gray-500 py-8">
