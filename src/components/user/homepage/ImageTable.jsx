     ...
     <div className='mx-auto max-w-screen-2xl px-6 sm:px-10'>
          <div className='hidden sm:block'>
            <div className='border-l border-r border-b rounded-b-3xl border-blue-600'>
              <img className='w-full h-auto object-cover' src="https://static.nike.com/a/images/f_auto/dpr_2.0,cs_srgb/w_1286,c_limit/384ca7d3-eef0-435f-b91b-273f7238e252/nike-just-do-it.png" alt="" />
          ...
          <div className='block sm:hidden'>
            <div className=''>
            <img className='w-full h-auto object-cover' src="https://static.nike.com/a/images/f_auto/dpr_2.0,cs_srgb/h_528,c_limit/20271b1c-8fae-446a-9794-cb061daeaa8e/nike-just-do-it.jpg" alt="" />
            <div className="">
