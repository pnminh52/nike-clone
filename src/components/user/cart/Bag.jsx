    ...
    return (
        <div>
            ...
            <div className='block sm:hidden'>
                <div className=''>
                    <div className='flex justify-center border-b  border-gray-300 py-6  w-full'>
                        <div >
                            <p className=" text-2xl">Bag</p>
                            <p className=' text-gray-400 text-center justify-center flex mx-auto'>{cart.length} items</p>
                        </div>
                    ...
                    <div className="space-y-4">
                            {cart.map((item, index) => (
                                <div key={index} className="flex gap-4 py-4  rounded border-b  border-gray-300 ">
                                    <div>
                                        <Link to={`/details/${item.name}`}>
                                            <img
                                                src={item.img}
                                    ...
                                    <div className=" w-full">
                                        ...
                                        <p className="text-lg">
                                            ...
                                            <p className="inter text-medium sm:text-lg">{item.name}</p>
                                            
                                       
                                        <p className="text-[#707072] text-medium sm:text-lg">
                                            {item.type}
                                        </p>
                                        <p className="text-[#707072] text-lg hidden sm:block">
                                            {" "}
                                            {Array.isArray(item.color)
                                                ? item.color.join("/")
                                                : item.color?.split(",").join("/")}
