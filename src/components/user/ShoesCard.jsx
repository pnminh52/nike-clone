    ...
    >
      <div className={`inter mb-14 ${hasVariants ? 'group' : ''}`}>
        ...
        <div className="mt-2">
          ...
          <p className="block group-hover:hidden">{product.name}</p>
          <p className="text-gray-500 block group-hover:hidden">{product.gender}'s Shoes</p>
          <p className="text-gray-500 block group-hover:hidden">1 Colour</p>
