  ...
  return (
    <div>
      <div className="bg-gray-100 hidden sm:block">
        <div className="container h-10 mx-auto px-10 max-w-screen-2xl flex justify-between items-center ">
          {/* Logo */}
          <svg
            aria-hidden="true"
            focusable="false"
            ...
            >
              {user ? (
                <div className="flex gap-1 items-center cursor-pointer inter h-10">
                  ...
                  <svg aria-hidden="true" className="icon-btn" focusable="false" viewBox="0 0 24 24" role="img" width="18px" height="18px" fill="none" aria-label="Profile"><path stroke="currentColor" strokeWidth="2" d="M3.75 21v-3a3.75 3.75 0 013.75-3.75h9A3.75 3.75 0 0120.25 18v3m-4.5-13.5a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"></path></svg>
                </div>
              ) : (
                <Link to="/login">
                  <p className="cursor-pointer inter">Sign In</p>
                </Link>
              )}
              ...
              {user && (
                <div
                  className={`absolute right-0 mt-0 w-56 bg-white shadow-lg rounded-2xl transition-all duration-300 z-50 ${
                    hover1
