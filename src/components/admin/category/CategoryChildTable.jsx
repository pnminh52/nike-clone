...
const CategoryChildTable = ({ categories, handleDeleteCategory }) => {
      ...
      <table className="min-w-full border bg-white">
        <thead className="bg-white">
          <tr className='text-center'>
            <th className="p-2 border border-gray-300 text-center font-medium inter">Name</th>
            <th className="p-2 border border-gray-300 text-center font-medium inter">Image</th>
            <th className="p-2 border border-gray-300 text-center font-medium inter">Actions</th>
          </tr>
        </thead>
        <tbody>
          {currentItems.map((category) => (
            <tr key={category.id}>
              ...
              <td className="border border-gray-300 p-2 text-center space-x-2">
                <Link to={`/admin/dashboard/categories/edit/${category.id}`}>
...
export default CategoryChildTable;
