...
const CategoryTable = ({
  ...
  const currentItems = parentCategories.slice(indexOfFirstItem, indexOfLastItem);
      ...
      <table className="min-w-full border bg-white">
        <thead>
          ...
          <th className="border border-gray-300 p-2 text-center">#</th>
            ...
            <th className="border border-gray-300 p-2 text-center">Số danh mục con</th>
  ...
  <div className="flex justify-center items-center h-full">
    ...
    />
              ...
              <td className="border border-gray-300 p-2 text-center">{category.page}</td>
              <td className="border border-gray-300 p-2 text-center space-x-2">
                ...
                <Link to={`/admin/dashboard/categories/view/${category.id}`}>
                  <button className="cursor-pointer">
