    ...
    <div className="overflow-x-auto p-4 border-gray-300 border bg-white rounded-2xl">
      <table className="min-w-full border bg-white">
        <thead className="bg-white">
          <tr>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Image</th>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Name</th>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Category</th>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Status</th>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Price</th>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Stock</th>
            <th className="p-2 border-gray-300 border text-center font-medium inter">Actions</th>
          </tr>
        </thead>
        <tbody>
          {currentProducts.map((product) => (
            <tr key={product.id} className="border-t">
              ...
              <td className="border border-gray-300 p-2 text-center"><p>{formatPrice(product.price)} <span className='text-xs underline'>đ</span></p>
              </td>
              <td className="border border-gray-300 p-2 text-center">{product.stock}</td>
              <td className="border border-gray-300 p-2 text-center space-x-2">
                <button onClick={() => handleDeleteProduct(product.id)} className="cursor-pointer">
                  {/* Trash Icon */}
                ...
                <button onClick={() => handleShowDetail(product)} className="cursor-pointer">
                  {/* Eye Icon */}
